 ...
 * ASSOC_ARRAY_MEM, ASSOC_ARRAY_KEY_EXISTS)
 */
 ...
 * \param[in] key - ключ
 * \param[out] num - указатель на значение, соответствующее ключу (в случае
 * успеха)
 *
 * \note Ключ не может быть пустой строкой.
 *
 ...
 *
 * \return ASSOC_ARRAY_OK или код ошибки (ASSOC_ARRAY_INVALID_PARAM,
 * ASSOC_ARRAY_MEM, ASSOC_ARRAY_NOT_FOUND)
 */
 ...
 *
 * \param[in] arr - описатель массива
 * \param[in] action - указатель на функцию обратного вызова для обработки
 * очередного значения \param[in] param - параметр функции обратного вызова
 * (может быть NULL)
 *
 * \return ASSOC_ARRAY_OK или код ошибки (ASSOC_ARRAY_INVALID_PARAM)
 */
 ...
 *
 * \param[in] arr - описатель массива
 * \param[out] num - указатель на значение, соответствующее минимальному ключу
 * (в случае успеха)
 *
 * \return ASSOC_ARRAY_OK или код ошибки (ASSOC_ARRAY_INVALID_PARAM,
 * ASSOC_ARRAY_NOT_FOUND - т.е. массив пустой)
 */
 ...
 *
 * \param[in] arr - описатель массива
 * \param[out] num - указатель на значение, соответствующее максимальному ключу
 * (в случае успеха)
 *
 * \return ASSOC_ARRAY_OK или код ошибки (ASSOC_ARRAY_INVALID_PARAM,
 * ASSOC_ARRAY_NOT_FOUND - т.е. массив пустой)
